...
//import com.eservice.ms_guide.consumer.UserGateway;
...
public class GuideService {
    ...
    public Guide getUser(String userName) {
...
//    public List<Provider> getTripDeals(GuideModel user, int numberOfAdults, int numberOfChildren, int tripDuration) {
